                ...
                <Col lg={6} className="hero-content mb-3">
                  <div className="fade-in-up">
                    ...
                    <div className="d-flex gap-3 flex-wrap">
                      ...
                      <Button className="contact-btn glass-btn" target="_blank"
                              href="https://www.linkedin.com/in/andrea-varnado/">
                        <IconWrapper Icon={FaLinkedin}/>
                      </Button>
                      <Button className="contact-btn glass-btn" target="_blank"
                              href="mailto:andrea.h.varnado@gmail.com">
      ...
      "Responsivity"
          ...
          >
            <Modal.Header closeButton
                          className={`modal-header-custom modal-header-custom-${currentProject?.title?.toLowerCase().replace(/\s+/g, '-')}`}>
